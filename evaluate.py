...
def evaluate_system(system, manager, n_jobs, description):
    ...
    for speaker_id, trials in manager.speaker_trials.iteritems():
        for trial in trials:
            ...
            likelihood_array.append(system.verify(trial.claimed_speaker, trial.get_data(),5000/2, 50, n_jobs))
...
if __name__=='__main__':
    ...
    evaluate_system(system, manager, -1)